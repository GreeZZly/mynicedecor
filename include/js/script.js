		...
		$.ajax({
			...
			success: function(datum){
				...
				$.each(datum, function(n,el){
					...
					text+='<div class="product_wrapper"><form name="prod_to_cart" method="post" action="/main/insert_to_cart"><a href="/index.php/main/viewProduct"><div class="pr_img"><img src="http://goodcrm.ru/'+el.path+'"></div></a><a href="/index.php/main/viewProduct"><div class="pr_name">'+el.product+'</div></a><div class="pr_type">'+el.type+'</div><div class="price">'+el.cost+' руб.</div><input type="hidden" name="product_id" value="'+el.id+'"><div class="buy_button" srv_id="'+el.id+'">Нравится</div></form></div>'
				});
